...
demo = {
  ...
  initChartPageCharts: function () {
    ...
    let chartActivity = document.getElementById('chartActivity');
    if (chartActivity) {
      ctx = chartActivity.getContext("2d");
  ...
  initDashboardPageCharts: function () {
    ...
    let chartDonut1 = document.getElementById('chartDonut1');
    if (chartDonut1) {
      ctx = chartDonut1.getContext("2d");
      myChart = new Chart(ctx, {
        type: 'pie',
        data: {
          labels: [1, 2],
    ...
    let chartdonut2 = document.getElementById('chartDonut2');

    if (chartdonut2) {
      ctx = chartdonut2.getContext("2d");
      myChart = new Chart(ctx, {
        type: 'pie',
        data: {
          labels: [1, 2],
    ...
    let chartdonut3 = document.getElementById('chartDonut3');
    if (chartdonut3) {
      ctx = chartdonut3.getContext("2d");
      myChart = new Chart(ctx, {
        type: 'pie',
        data: {
          labels: [1, 2],
    ...
    let chartdonut4 = document.getElementById('chartDonut4');
    if (chartdonut4) {
      ctx = chartdonut4.getContext("2d");
    ...
    let emailsCampaignChart = document.getElementById('emailsCampaignChart');
    if (emailsCampaignChart) {
      ctx = emailsCampaignChart.getContext("2d");
    ...
    let activeCountries = document.getElementById("activeCountries");
    if (activeCountries) {
      var e = activeCountries.getContext("2d");
